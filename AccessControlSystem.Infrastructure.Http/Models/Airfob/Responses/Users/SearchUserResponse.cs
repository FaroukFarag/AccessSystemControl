...
public class SearchUserResponse
{
    ...
    public List<object> UserGroups { get; set; } = default!;

    [JsonPropertyName("access_levels")]
    public List<SearchUserAccessLevel> AccessLevels { get; set; } = default!;

    [JsonPropertyName("floor_levels")]
    public List<object> FloorLevels { get; set; } = default!;

    [JsonPropertyName("card_type")]
    public string CardType { get; set; } = default!;

    [JsonPropertyName("card_types")]
    public List<string> CardTypes { get; set; } = default!;
}
