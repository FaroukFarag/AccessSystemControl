    ...
    public partial class ModifyTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessGroupDevices", x => new { x.AccessGroupId, x.DeviceId });
                    table.ForeignKey(
                        name: "FK_AccessGroupDevices_AccessGroups_AccessGroupId",
                        column: x => x.AccessGroupId,
                        principalTable: "AccessGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessGroupDevices_Devices_DeviceId",
                        column: x => x.DeviceId,
