...
namespace AccessControlSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250824135155_RemoveUserAndAddUnitToCard")]
    partial class RemoveUserAndAddUnitToCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccessControlSystem.Domain.Models.AccessGroups.AccessGroup", b =>
                {
                    ...
                    b.Property<int>("AirfobAccessLevelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccessControlSystem.Domain.Models.Visitors.Visitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccessGroupVisitor", b =>
                {
                    ...
                    b.HasKey("AccessGroupsId", "VisitorsId");

                    b.HasIndex("VisitorsId");

                    b.ToTable("AccessGroupVisitor");
                });
            ...
            modelBuilder.Entity("AccessGroupVisitor", b =>
                {
                    b.HasOne("AccessControlSystem.Domain.Models.AccessGroups.AccessGroup", null)
                        .WithMany()
                        .HasForeignKey("AccessGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AccessControlSystem.Domain.Models.Visitors.Visitor", null)
                        .WithMany()
